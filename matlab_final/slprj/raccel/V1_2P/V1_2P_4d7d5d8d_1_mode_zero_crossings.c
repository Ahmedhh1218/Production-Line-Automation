...
const NeZCData *V1_2P_4d7d5d8d_1_ZCData = NULL;
PmfMessageId V1_2P_4d7d5d8d_1_computeAsmModeVector(const double *input, const
...
PmfMessageId V1_2P_4d7d5d8d_1_computeSimModeVector(const double *input, const
  double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId V1_2P_4d7d5d8d_1_computeZeroCrossings(const
